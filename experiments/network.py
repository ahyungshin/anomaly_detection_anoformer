...
from plotUtil import plot_dist,save_pair_fig,save_plot_sample,print_network,save_plot_pair_sample,loss_plot, auc_plot
...
class AD_MODEL(object):
    ...
    def save(self,train_hist):
        ...
        fname = os.path.join(save_dir, self.model + '_history.pkl')
    ...
    def saveTestPair(self,pair,save_dir):
        ...
        for idx,p in enumerate(pair):
            ...
            output=p[1]
            score=p[2]
            save_pair_fig(input,output,score,os.path.join(save_dir,str(idx)+".png"))
